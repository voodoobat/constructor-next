    ...
    <div className={classNames(className, scss._)}>
      ...
      <div className={scss.content}>
        {/* <Legend className={scss.legend}>
          <Group canvas={[[3,3,3,7], [9,3,5,21]]} />
        </Legend>
        <Legend className={scss.legend}
                legend="Стопицот колонок">
          <Group canvas={[[3,3,3,7,4,4,9,27,9,3,5,21,23,23,7,4,9,27,9,3,5,21]]} />
        </Legend>
        <Legend className={scss.legend}
                legend="Стопицот рядов">
          <Group canvas={[[3], [9], [3], [27], [4], [9], [27], [33], [3]]} />
        </Legend>
        <Legend className={scss.legend}>
          <Group canvas={[[3,3,3,7,4,4,9,27], [9,3,5,21,23,23,7,4]]} />
        </Legend> */}
      </div>
    </div>
  )
